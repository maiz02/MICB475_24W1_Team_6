...
## FORMATTED BRAY CURTIS FOR ASTHMA
# ellipse around asthma
updated_bc_asthma_pcoa_ellipse_asthma <- plot_ordination(ms_rare, pcoa_asthma_bc, shape = "upf_status", color = "asthma_yn") +
...
updated_bc_asthma_pcoa_ellipse_asthma

# ellipse around UPF status
updated_bc_asthma_pcoa <- plot_ordination(ms_rare, pcoa_asthma_bc, shape = "asthma_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of asthma") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
                     labels = c("No asthma", "Asthma")) + 
...
## FORMATED BRAY CURTIS FOR ALLERGIES
# ellipse around allergies
updated_bc_allergies_pcoa_ellipse_allergies <- plot_ordination(ms_rare, pcoa_allergies_bc, shape = "upf_status", color = "allergies_yn") +
...
updated_bc_allergies_pcoa_ellipse_allergies

# ellipse around UPF status
updated_bc_allergies_pcoa <- plot_ordination(ms_rare, pcoa_allergies_bc, shape = "allergies_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of allergies") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
                     labels = c("No allergies", "Allergies")) + 
...
## FORMATTED JACCARD FOR ASTHMA
# ellipse around asthma
updated_jaccard_asthma_pcoa_ellipse_asthma <- plot_ordination(ms_rare, pcoa_asthma_jaccard, shape = "upf_status", color = "asthma_yn") +
  labs(col = "Presence of asthma", pch = "UPF Status") + 
  stat_ellipse(aes(group = asthma_yn, color = asthma_yn), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
  ...
  scale_color_manual(values = c("#F8766D", "#00BFC4"),  
                     labels = c("No asthma", "Asthma")) 
updated_jaccard_asthma_pcoa_ellipse_asthma

# ellipse around UPF status
updated_jaccard_asthma_pcoa <- plot_ordination(ms_rare,  pcoa_asthma_jaccard, shape = "asthma_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of asthma") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
...
## FORMATTED JACCARD FOR ALLERGIES
# ellipse around allergies
updated_jaccard_allergies_pcoa_ellipse_allergies <- plot_ordination(ms_rare, pcoa_allergies_jaccard, shape = "upf_status", color = "allergies_yn") +
  labs(col = "Presence of allergies", pch = "UPF Status") + 
  stat_ellipse(aes(group = allergies_yn, color = allergies_yn), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
  ...
  scale_color_manual(values = c("#F8766D", "#00BFC4"),  
                     labels = c("No allergies", "Allergies")) 
updated_jaccard_allergies_pcoa_ellipse_allergies

# ellipse around UPF status
updated_jaccard_allergies_pcoa <- plot_ordination(ms_rare, pcoa_allergies_jaccard, shape = "allergies_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of allergies") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
...
## FORMATTED WUNI FOR ASTHMA
# ellipse around asthma
updated_wuni_asthma_pcoa_ellipse_asthma <- plot_ordination(ms_rare, pcoa_asthma_wuni, shape = "upf_status", color = "asthma_yn") +
  labs(col = "Presence of asthma", pch = "UPF Status") + 
  stat_ellipse(aes(group = asthma_yn, color = asthma_yn), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
...
updated_wuni_asthma_pcoa_ellipse_asthma

# ellipse around UPF status
updated_wuni_asthma_pcoa <- plot_ordination(ms_rare,  pcoa_asthma_wuni, shape = "asthma_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of asthma") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
...
## FORMATTED WUNI FOR ALLERGIES
# ellipse around allergies
updated_wuni_allergies_pcoa_ellipse_allergies <- plot_ordination(ms_rare, pcoa_allergies_wuni, shape = "upf_status", color = "allergies_yn") +
  labs(col = "Presence of allergies", pch = "UPF Status") + 
  stat_ellipse(aes(group = allergies_yn, color = allergies_yn), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
  ...
  scale_color_manual(values = c("#F8766D", "#00BFC4"),  
                     labels = c("No allergies", "Allergies")) +
  xlim(-0.1, 0.05) + ylim(-0.050, 0.015)
updated_wuni_allergies_pcoa_ellipse_allergies

# ellipse around UPF status
updated_wuni_allergies_pcoa <- plot_ordination(ms_rare, pcoa_allergies_wuni, shape = "allergies_yn", color = "upf_status") +
  labs(col = "UPF Status", pch = "Presence of allergies") + 
  stat_ellipse(aes(group = upf_status, color = upf_status), level = 0.95, linewidth = 0.8, show.legend = TRUE) + 
  guides(shape = guide_legend(override.aes = list(linetype = 0))) + 
  scale_shape_manual(values = c(16, 17),
